...
public class InterviewProgram8 {
	...
	public static void main(String[] args) {
		...
		Employee1 highestPaid=	highestPaidEmployee.get();
		...
		System.out.println("Year Of Joining : "+highestPaid.getYearOfJoining());
		...
		Map<String ,Long> numberOfEmployeeCount=
		employeeList.stream()
		.collect(Collectors.groupingBy(Employee1::getDepartment
				,Collectors.counting()));
		System.out.println(numberOfEmployeeCount);
	}
